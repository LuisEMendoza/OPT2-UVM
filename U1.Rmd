...
Debemos cargar la biblioteca _lpSolve_ y capturar los comandos necesarios para su resolución:
...
El cálculo de ruta crítica muestra que _B-D-E-F-H_ es la ruta crítica y que el tiempo de terminación del proyecto esperado es de 21 semanas. Después de revisar esta información, la gerencia afirmó que se utilizará tiempo extra para completar el proyecto en 16 semanas. 
